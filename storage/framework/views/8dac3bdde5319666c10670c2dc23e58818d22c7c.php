<h5 onclick="showExperience();"><?php echo e(__('Experience')); ?></h5>
<div class="row">
    <div class="col-md-12">
        <div class="" id="experience_div"></div>
    </div>
</div>
<a href="javascript:;" onclick="showProfileExperienceModal();"> <?php echo e(__('Add Experience')); ?> </a>
<hr>
...
<script type="text/javascript">
    ...
    $.ajax({
    type: "POST",
            url: "<?php echo e(route('get.front.profile.experience.form', $user->id)); ?>",
    ...
    $.ajax({
    type: "POST",
            url: "<?php echo e(route('get.front.profile.experience.edit.form', $user->id)); ?>",
            data: {"profile_experience_id": profile_experience_id, "_token": "<?php echo e(csrf_token()); ?>"},
            datatype: 'json',
            success: function (json) {
            $("#add_experience_modal").html(json.html);
            initdatepicker();
    ...
    if (confirm(msg)) {
    $.post("<?php echo e(route('delete.front.profile.experience')); ?>", {id: id, _method: 'DELETE', _token: '<?php echo e(csrf_token()); ?>'})
    ...
    {
    $.post("<?php echo e(route('show.front.profile.experience', $user->id)); ?>", {user_id: <?php echo e($user->id); ?>, _method: 'POST', _token: '<?php echo e(csrf_token()); ?>'})
            .done(function (response) {
...
$(".datepicker").on('change', function(event) {
  ...
  /* Act on the event */
    ...
    if (country_id != ''){
    $.post("<?php echo e(route('filter.lang.states.dropdown')); ?>", {country_id: country_id, state_id: state_id, new_state_id: 'experience_state_id', _method: 'POST', _token: '<?php echo e(csrf_token()); ?>'})
            .done(function (response) {
