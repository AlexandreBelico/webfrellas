...
<html lang="en">
    ...
    <body style="margin:0; padding:0;" bgcolor="#F0F0F0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#24140e">
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="container" style="width:100%;border: solid 1px #d6d4d4;">
                            ...
                            <td class="content" align="left" style="padding-top:0px;padding-bottom:12px;background-color:#f8f8f8;"><table border="0" cellpadding="0" cellspacing="0" class="force-row" style="width:100%;">
                                    <tr>
                                        <td align="center" valign="middle" class="content-wrapper" style="padding-left:24px;padding-right:24px"><br>
                                            <a href="<?php echo e(url('/login')); ?>"><img src="<?php echo e(asset('/')); ?>sitesetting_images/thumb/<?php echo e($siteSetting->site_logo); ?>" /></a></td>
                                    </tr>
                                </table></td>
                        </tr>
                        <tr>
                            <td class="content" align="left" style="padding-top:0px;padding-bottom:12px;background-color:#fff"> <?php echo $__env->yieldContent('content'); ?> </td>
                        </tr>
                        <tr style="background-color: #fff;">
                            <td class="container-padding footer-text" align="left" style="font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#aaaaaa;padding: 20px 20px;"><div class="soc"> 
                                    <?php echo $__env->make('admin.layouts.email_template_social', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                <br>
                                <span class="ios-footer" style=" text-align:center;display: block;"> © Copyright <?php echo e(date('Y')); ?> <?php echo e($siteSetting->site_name); ?> - All Rights Reserved </span> <br>
                                <br></td>
                        </tr>
                    </table>
                    <!--/600px container --></td>
