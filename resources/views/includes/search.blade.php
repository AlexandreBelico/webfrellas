...
<div class="tp-banner-container">
    <div class="tp-banner" >
        ...
        @if(isset($sliders) && count($sliders))
            ...
            <!--Slide-->
            <li data-slotamount="7" data-transition="slotzoom-horizontal" data-masterspeed="1000" data-saveperformance="on"> <img alt="{{$slide->slider_heading}}" src="{{asset('/')}}images/slider/dummy.png" data-lazyload="{{ ImgUploader::print_image_src('/public/slider_images/'.$slide->slider_image) }}">
