        ...
        <div class="row"> 
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    <li class="{{ Request::url() == route('cms', $footer_menu->page_slug) ? 'active' : '' }}"><a href="{{ route('cms', $footer_menu->page_slug) }}">{{ $cmsContent->page_title   or ''}}</a></li>
                    @endforeach
                </ul>
            </div>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="paylogos"><img src="{{asset('/public/')}}images/payment-icons.png" alt="" /></div>	
            </div>
        </div>
