<div class="section">
    <div class="container">
        <div class="topsearchwrap">
			<div class="tabswrap">
				<div class="row">
					<div class="col-md-4"><h3>{{__('Browse Jobs')}}</h3></div>
					<div class="col-md-8">
						<ul class="nav nav-tabs">
						  <li class="active"><a data-toggle="tab" href="#byfunctional" aria-expanded="true">{{__('Browse By Functional Area')}}</a></li>
						  <li class=""><a data-toggle="tab" href="#bycities" aria-expanded="false">{{__('Browse By Cities')}}</a></li>
						  <li class=""><a data-toggle="tab" href="#byindustries" aria-expanded="false">{{__('Browse By Industries')}}</a></li>
						</ul>
					</div>
				</div>
