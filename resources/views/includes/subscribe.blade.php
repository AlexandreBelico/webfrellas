  ...
  <div class="container">
    ...
    <div class="row">
      ...
      {{ csrf_field() }}
		   ...
		   <div class="row">
			   <div class="col-md-5"><input type="text" class="form-control" placeholder="{{__('Name')}}" name="name" id="name" required="required"></div>
			    <div class="col-md-5"><input type="text" class="form-control" placeholder="{{__('Email')}}" name="email" id="email" required="required"></div>
			    <div class="col-md-2"><button class="btn btn-default" type="button" id="send_subscription_form">{{__('Subscribe')}}</button></div>		 
		</div>
