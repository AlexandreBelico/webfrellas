...
<head>
    ...
    <!-- Slider -->
    <link href="{{asset('/public/js/revolution-slider/css/settings.css')}}" rel="stylesheet">
    <!-- Owl carousel -->
    ...
    <!-- Rtl Style -->
    <link href="{{asset('/public/css/rtl-style.css')}}" rel="stylesheet">
    @endif
...
<body>
    @if(Auth::check() && !Auth::guard('company')->check())
        <section class="job-display">
            <ul class="job-list" id="job-list">
                {{--<li class="job-1 notify newJob job-1" id="newJob">
                    <a href="#" style="text-decoration: none; color: #000;">
                        <button id="close-job" class="btn-circle close-job" style="">x</button>
                        Need to develop new website
                    </a>
                </li>--}}
            </ul>
        </section>
    ...
    <script type="text/JavaScript">
        ...
        function getClientJobslist(clientId) {
            ...
            $.ajax({
            method: 'POST',
            url: '{{route("job.gethiredjobslist")}}',
        ...
        function verifywork(milestoneId) {
            ...
            $.ajax({
            method: 'POST',
            url: '{{route("milestone.verifywork")}}',
        ...
        notifyChannel.bind('App\\Events\\JobApplyEvent', function(data) {
            ...
            /*if(notification_user_id !='' && notification_msg!=''){
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{route("post.notifications.details")}}',
