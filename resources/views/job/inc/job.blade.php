...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_rate_type') !!}" id="job_rate_type_div"> {!! Form::select('job_rate_type', ['' => __('Select Job Rate Type')]+$jobRateType, null, array('class'=>'form-control', 'id'=>'job_rate_type')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'job_rate_type') !!} 
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="formrow">
            ...
            @else
            <button type="submit" class="btn">{{__('Create Job')}}<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
            @endif
