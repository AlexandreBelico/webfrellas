                        ...
                        <li id="job_li_{{$job->id}}">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">                
                                    <div class="listbtn"><a href="{{route('list.favourite.applied.users', [$job->id])}}">{{__('Hired Freelancer')}}</a></div>
                                    ...
                                    <div class="listbtn"><a href="{{route('milestones.list', [$job->id])}}">{{__('Milestones')}}</a></div>
                                     <div class="listbtn"><a href="{{route('timesheet.details', [$job->id])}}">{{__('Timesheets')}}</a></div>
                                     <!-- Added By hetal END -->
                                    <div class="listbtn"><a href="javascript:;" 
                                        onclick="deleteJob({{$job->id}})">{{__('Delete')}}</a></div>
                                </div>
                            </div>
