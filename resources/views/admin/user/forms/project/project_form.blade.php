<div class="modal-body">
    <div class="form-body">
        <div class="form-group" id="div_name">
            ...
            <input class="form-control" autocomplete="off" id="name" placeholder="Project Name" name="name" type="text" value="{{(isset($profileProject)? $profileProject->name:'')}}">
        ...
        <div class="form-group" id="div_url">
            ...
            <input class="form-control" id="url" placeholder="Project URL" autocomplete="off" name="url" type="text" value="{{(isset($profileProject)? $profileProject->url:'')}}">
        ...
        <div class="form-group" id="div_date_start">
            ...
            <input class="form-control datepicker" id="date_start" placeholder="Project Start Date" autocomplete="off" name="date_start" type="text" autocomplete="off" value="{{(isset($profileProject)? $profileProject->date_start:'')}}">
        ...
        <div class="form-group" id="div_date_end">
            ...
            <input class="form-control datepicker" autocomplete="off" id="date_end" placeholder="Project End Date" autocomplete="off" name="date_end" type="text" value="{{(isset($profileProject)? $profileProject->date_end:'')}}">
