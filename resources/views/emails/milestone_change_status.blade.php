                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                <div class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:16px;font-weight:400;color:#333;padding-bottom:20px; text-align: center;">
                                    <br>
                                     {{ $user }} has changed the milestone status for the job : <b> {{ $jobname }} </b>.
                                </div>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <div style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 8px;font-weight: 600;color: darkslategray; padding-bottom: 30px;text-align: center;"><br>{{ $siteSetting->site_name }} Team</div>
                            </tr>
                        </table>
                        <br>
                    </td>
