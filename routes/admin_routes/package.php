...
Route::get('profit-package', array_merge(['uses' => 'Admin\PackageController@profitSet'], $all_users))->name('profit.package');
Route::post('store-profit', array_merge(['uses' => 'Admin\PackageController@storeProfit'], $all_users))->name('store.profit');
