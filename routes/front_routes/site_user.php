...
/* Routes for chat */
Route::get('my-chats', 'Job\SeekerSendController@chats_page')->name('my.chats');
Route::post('get-company-messages', 'Job\SeekerSendController@get_company_messages')->name('get-company-messages');
Route::post('post-company-messages', 'Job\SeekerSendController@post_company_messages')->name('post-company-messages');
Route::get('test', 'Job\SeekerSendController@test');
Route::get('/sender-form', 'Job\SeekerSendController@sender_form')->name('sender-form');
Route::post('get-company-last-message', 'Job\SeekerSendController@get_last_message')->name('get-company-last-message');

/* Routes for chat */

/* Routes for file upload */
Route::post('fileupload-action', 'Job\SeekerSendController@fileupload_action')->name('fileupload.post');
Route::post('deletefile-post', 'Job\SeekerSendController@deletefile_action')->name('deletefile-post');
