...
class User extends Authenticatable
{
    ...
    public function printUserImage($width = 0, $height = 0)
    {
        ...
        return \ImgUploader::print_image("public/user_images/$image", $width, $height, '/admin_assets/no-image.png', $this->getName());
    }
    ...
    {
        return CompanyMessage::where('seeker_id', '=', $this->id)->where('company_id', '=', $id)->where('type', 'message')->where('status','unviewed')->count();
    }
}
