...
class JobFormRequest extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'salary_from.required' => 'Please select project Budget.',
            'salary_to.required' => 'Please select salary to.',
            'salary_currency.required' => 'Please select Project currency.',
            'salary_period_id.required' => 'Please select Project period.',
