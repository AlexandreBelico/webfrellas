...
class JobFrontFormRequest extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'salary_from.required' => __('Please select project budget'),
            'salary_to.required' => __('Please select project to'),
            'salary_currency.required' => __('Please select project currency'),
            'salary_period_id.required' => __('Please select Project Length'),
            ...
            'job_rate_type.required'=>__('Please select Job rate type')
        ];
    }
