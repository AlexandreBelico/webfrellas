...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        'App\Console\Commands\TimesheetCron',  // Added by Hetal
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->call('App\Http\Controllers\Job\JobController@timesheetWeeklyReport')->weeklyOn(1, '9:00'); // Above line Added by hetal
        $schedule->call('App\Http\Controllers\OrderController@weeklyPayment')->everyMinute();
